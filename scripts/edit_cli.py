...
if __name__ == "__main__":
    input_path = '/home/Newdisk2/zhanghe/git_repo/instruct-pix2pix-main/微信图片编辑_20241114201757.jpg'
    output_dir = '/home/Newdisk2/zhanghe/git_repo/instruct-pix2pix-main/cartoon/'
    instruction = 'turn it into a cartoon'
    #instruction = 'Give it a cartoon treatment '
    for i in range(30):
        output_path = os.path.join(output_dir,'{}.png'.format(i))
        print(f"{output_path}")
        edit_main(input_path,output_path,instruction)
